...
export const SearchBarImg = styled.div`
  background-image: url(${ProgressBar2});
  background-size: 70%;
...
export const ContentLeftSection1 = styled.div`
  align-self: center;
  width: 100%;
  padding: 20px 0;
  border-bottom: 1px solid ${({ theme }) => theme.colors.white};
...
export const SectionSummary = styled(SectionHeader)`
  align-self: flex-end;
...
export const ContentLeftSection2 = styled.div`
  display: flex;
  flex-direction: column;
  margin: 15px 0;
  padding: 10px 0;
